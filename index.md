...
1. **Использование внеигровой информации (метагейминг) запрещено.**
   - Под запретом любой OOC источник.
   - Не кооперируйтесь с другими игроками через сторонние чаты.
   - Исключение: Если вы обучаете новичка, заранее предупредите администрацию.
   - По-умолчанию ваш персонаж не знает ничего о некоторых [антагонистах](https://wiki.taucetistation.org/Identifying_Antagonists).

1. **IC в OOC запрещено.** 
   - Сюда попадает как игровой OOC канал, так и другие средства общения.
   - Публикацию жалобы по событиям раунда отложите до его окончания.
   - Прямые трансляции раундов без предварительного согласования с администрацией запрещены.
      - Записи или логи вашей игры на сервере могут быть опубликованы только после завершения раунда.

1. **Стремление любыми способами «победить в игре» (пауэргейминг) запрещено.**
Не получайте игровых преимуществ в ущерб созданию интересных игровых ситуаций и удовольствию других игроков. Под запретом также:
   - «Охота» на антагонистов. 
      - Не пытайтесь любыми средствами найти или вывести их из игры, если это не обусловлено игровыми обстоятельствами. Относитесь к ним так же, как если бы вы не знали об их роли.
   - Манчкинизм — стремление снарядить своего персонажа на все случаи жизни, не учитывая конкретной ситуации.
   - Использование багов. Сообщайте о них на [гитхаб](https://github.com/TauCetiStation/TauCetiClassic/issues).
   - Использование каких-либо видов стороннего ПО.
   - При угрозах, направленных на уничтожение станции или экипажа, всем членам экипажа разрешено прямое противостояние для защиты своей жизни. При этом приоритет остаётся за Службой Безопасности — следует по возможности выполнять их указания и не мешать.
